...
export default function MenuPage() {
  ...
  const updateCategory =
    async () => {
      ...
      try {
        ...
        await api.put(
          `/auth/menu/categories/${editingCategory.id}`,
          {
            name:
    ...
    async (
      ...
      const confirmed =
        await confirmDialog({
          ...
          message:
            "This category and all of its menu items will be permanently deleted.",
  ...
  const updateItem =
    async () => {
      ...
      try {
        ...
        await api.put(
          `/auth/menu/items/${editingItem.id}`,
          {
            menu_category_id:
              Number(
                editItemForm
  ...
  const toggleAvailability =
    async (
      ...
      try {
        await api.patch(
          `/auth/menu/items/${id}/availability`,
          {},
          authConfig()
        );
            ...
            <div className="dashboard-welcome">
              <div className="welcome-content">
                ...
                <div className="welcome-left">
                  ...
                  <p>
                    Add, edit and manage your restaurant menu categories and items
                  </p>
                ...
                <div className="form-grid">
                  ...
                  <div className="form-group">
                    ...
                    <div className="input-wrapper">
                      ...
                      <input
                        type="text"
                        placeholder="e.g., Pizzas, Beverages"
                        value={
                          categoryName
                        }
                        onChange={(e) =>
                  ...
                  <div className="form-group">
                    ...
                    <div className="input-wrapper">
                      ...
                      <i className="fas fa-align-left input-icon" />
                ...
                <div className="form-grid">
                  ...
                  <div className="form-group">
                    ...
                    <div className="input-wrapper">
                      ...
                      <i className="fas fa-folder input-icon" />
                  ...
                  <div className="form-group">
                    ...
                    <div className="input-wrapper">
                      ...
                      <i className="fas fa-utensils input-icon" />
                  ...
                  <div className="form-group">
                    ...
                    <div className="input-wrapper">
                      ...
                      <i className="fas fa-leaf input-icon" />
              ...
              <div className="dashboard-section">
                ...
                {loading ? (
                  ...
                  <div className="empty-state">
                    ...
                    <p>
                      Add a category to start building your restaurant menu.
                    </p>
                                    ...
                                    (
                                      ...
                                      >
                                        ...
                                        <td>
                                          ...
                                          <span
                                            className={`food-type-badge food-type-${item.food_type}`}
                                          >

                                            <span
                                              className={`food-dot ${item.food_type}`}
                                            />
