                    ...
                    <div className="menu-category-card" key={category.id}>
                      ...
                      >
                        ...
                        <div className="category-header-right">
                          ...
                          <i
                            className={`fas fa-chevron-down category-arrow ${activeCategory === category.id ? "arrow-rotated" : ""
                              }`}
                          ></i>
                        </div>
                      </div>
                      ...
                      {/* Items */}
                      <div
                        className={`category-items ${activeCategory === category.id ? "category-expanded" : "category-collapsed"
                          }`}
                      >
                              ...
                              <div className="menu-item-row" key={item.id}>
                                <div className="item-left">
                                  <div className="item-name-row">
                                    <h4>{item.name}</h4>
                                    <span
                                      className={`food-dot ${item.food_type === "non_veg"
                                          ? "nonveg"
                                          : item.food_type === "egg"
                                            ? "egg"
                                            : "veg"
                                ...
                                <div className="item-right">
                                  ...
                                  <span
                                    className={`item-status ${item.is_available ? "status-available" : "status-unavailable"
                                      }`}
                                  >
                                    <span
                                      className={`status-dot-sm ${item.is_available ? "dot-available" : "dot-unavailable"
                                        }`}
                                    ></span>
